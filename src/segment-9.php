...
<html>
	...
	<body>
		...
		<table class="segment_data_table">
		  <tr>
		    <td><?php print(i18n('segment_data.length', $lang)); ?></td><td>6.94 km</td>
		  </tr>
		  <tr>
		    <td><?php print(i18n('segment_data.max_elevation', $lang)); ?></td><td>2387 m</td>
		  </tr>
		  <tr>
		    <td><?php print(i18n('segment_data.min_elevation', $lang)); ?></td><td>2281 m</td>
		  </tr>
		</table>
