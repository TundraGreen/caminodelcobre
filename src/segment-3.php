...
<html>
	...
	<body>
		...
		<table class="segment_data_table">
		  <tr>
		    <td><?php print(i18n('segment_data.length', $lang)); ?></td><td>1.48 km</td>
		  </tr>
		  <tr>
		    <td><?php print(i18n('segment_data.max_elevation', $lang)); ?></td><td>2460 m</td>
		  </tr>
		  <tr>
		    <td><?php print(i18n('segment_data.min_elevation', $lang)); ?></td><td>2448 m</td>
		  </tr>
		</table>
